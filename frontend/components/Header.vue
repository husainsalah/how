...
<template>
  ...
  >
    <div class="container py-6 sm:px-6">
      <div class="flex justify-center justify-between gap-5">
        ...
        <nav>
          <div>
            ...
            <div>
              <ul
            role="list"
            class="flex justify-center gap-4 md:gap-6 leading-5 text-white text-sm md:text-base tracking-tight font-normal"
          >
